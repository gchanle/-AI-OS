...
const DEFAULT_AGENT_RUNTIME_CONFIG = {
    ...
    runtime: {
        ...
        enableThreadStateProjection: true,
        enableTodoProjection: true,
        enableArtifactProjection: true,
        maxSubtasksPerRun: 6,
...
function normalizeAgentRuntimeConfig(raw = {}) {
    ...
    return {
        ...
        runtime: {
            architectureProfile: String(config.runtime?.architectureProfile || DEFAULT_AGENT_RUNTIME_CONFIG.runtime.architectureProfile),
            ...
            enableThreadStateProjection: typeof config.runtime?.enableThreadStateProjection === 'boolean'
                ? config.runtime.enableThreadStateProjection
                : DEFAULT_AGENT_RUNTIME_CONFIG.runtime.enableThreadStateProjection,
            enableTodoProjection: typeof config.runtime?.enableTodoProjection === 'boolean'
                ? config.runtime.enableTodoProjection
                : DEFAULT_AGENT_RUNTIME_CONFIG.runtime.enableTodoProjection,
            enableArtifactProjection: typeof config.runtime?.enableArtifactProjection === 'boolean'
                ? config.runtime.enableArtifactProjection
                : DEFAULT_AGENT_RUNTIME_CONFIG.runtime.enableArtifactProjection,
