...
def get_chat_llm(temperature=0, model_name=None):
    return ChatOpenAI(
        temperature=temperature,
        model_name=model_name or os.getenv("PAPERHELPER_CHAT_MODEL", "qwen3.5-plus"),
...
def get_rag_chain(file_name="Mahmoudi_Nima_202202_PhD.pdf", index_folder="index", retrieval_cb=None):
    ...
    conversational_qa_chain = _inputs | _context | ANSWER_PROMPT | get_chat_llm()
...
def get_search_tool_from_indexes(search_indexes, st_cb=None):
